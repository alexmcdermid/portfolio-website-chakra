...
import { DiMongodb, DiReact, DiNodejsSmall, DiHtml5, DiCss3, DiJavascript } from 'react-icons/di'
    ...
    return (
        <Stack>
            <Flex direction={isNotSmallerScreen ? "row" : "column"} spacing="200px" p={isNotSmallerScreen ? "16" : "0"} align="flex-start">
                <Box mt={isNotSmallerScreen ? "0" : '8'} align='center'>
                    ...
                    <Flex direction='row' spacing="200px"  textAlign='center'  >
                        <Flex flexDirection='column' p={isNotSmallerScreen ? "6" : "2"} align='center'>
                            <DiMongodb size={isNotSmallerScreen ? '5em' : '4em'}/>
                            <Text>MongoDB</Text>
                        </Flex>
                        <Flex flexDirection='column' p={isNotSmallerScreen ? "6" : "2"} align='center'>
                            <SiExpress size={isNotSmallerScreen ? '5em' : '4em'}/>
                            <Text>Express.js</Text>
                        </Flex>
                        <Flex flexDirection='column' p={isNotSmallerScreen ? "6" : "2"} align='center'>
                            <DiReact size={isNotSmallerScreen ? '5em' : '4em'}/>
                            <Text>React.js</Text>
                        </Flex>
                        <Flex flexDirection='column' p={isNotSmallerScreen ? "6" : "2"} align='center'>
                            <DiNodejsSmall size={isNotSmallerScreen ? '5em' : '4em'}/>
                            <Text>Node.js</Text>
                        </Flex>
                    </Flex>
                    </Flex>
